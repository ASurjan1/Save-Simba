...
uint32_t ST7735_DrawString(uint16_t x, uint16_t y, char *pt, int16_t textColor){
  ...
  if(y>15) return 0;
  while(*pt){
    ST7735_DrawCharS(x*6, y*10, *pt, textColor, ST7735_BLUE, 1);
    pt++;
    x = x+1;
...
void ST7735_OutUDecBG(uint16_t x, uint16_t y, uint32_t n, int16_t textColor, int16_t bgColor){
  Dec2String(n,Message);
  ST7735_DrawStringBG(x,y,Message,textColor,bgColor);
  int i = 0;
  while(Message[i]){
    x = x+1;
    i++;
  ...
  if(x>20){
    x = 20;
    ST7735_DrawCharS(x*6,y*10,'*',ST7735_RED,ST7735_BLACK, 1);
  }
}
